  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 flex justify-between items-center py-4 px-6 bg-white  font-custom text-custom">
      ...
      <nav className="flex space-x-4 mr-40 gap-7">
        ...
        <Link to="/frontend/froker-app/src/components/Blogs/Blogs.jsx" className="text-orange-600 font-normal">Blogs</Link>
        <Link to="/frontend/froker-app/src/components/Discover/Discover.jsx" className="text-orange-600 font-normal">Discover Froker</Link>
      </nav>
    </header>
  );
};
